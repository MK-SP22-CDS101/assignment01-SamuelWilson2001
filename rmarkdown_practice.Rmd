...
* By the end of the course, studetns will be able to:
  * My GitHub username is: *SamuelWilson2001*
...
x +3
```
The output of the first line of code is not printed out because it assigned to a variable instead.
